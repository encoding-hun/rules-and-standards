...
sites = []
groups = ['Legacy', 'pcroland', 'NFC', 'NaGa', 'boOk', 'SFY', 'PTHD', 'FULCRUM', 'DenZo', 'prldm', 'VARYG', '14V1', 'GS88', 'JBR', 'MGM', 'Fodyna', 'EKG', 'gyontato', 'WildCat']
banned_groups = []
...
| [**> WEB-es rövidítések listája**](/files/web-abbreviation.md) | {   t5    }      | 2021.01.06. |
