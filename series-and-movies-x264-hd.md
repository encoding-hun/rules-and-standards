...
## 8) Videokódolás
  ...
  - 8.2) Minimum `r3000`-es x264 használata kötelező; kivétel, ha korábbi, minőségi encodera (pl. `DON`, `TayTo`, `VietHD` és egyéb HDB internalok; megbízható források) muxolunk.
...
## 10) Audiokódolás
  ...
  - 10.13) Amennyiben a forrás `AC3` vagy `DTS`, és újrakódolás szükséges, akkor az újrakódolt hang bitrátája nem lehet magasabb, mint a forrásé.
